/*
  ESP8266WiFiMesh2.cpp - Mesh network node
...
ESP8266WiFiMesh2::ESP8266WiFiMesh2(uint32_t chip_id, std::function<String(String)> handler)
: _server(SERVER_PORT)
{
	_chip_id = chip_id;
 ...
 * 
 */
bool ESP8266WiFiMesh2::waitForClient(WiFiClient curr_client, int max_wait)
{
	int wait = max_wait;
 ...
 * 
 */
bool ESP8266WiFiMesh2::exchangeInfo(String message, WiFiClient curr_client)
{
 ...
 * 
 */
void ESP8266WiFiMesh2::connectToNode(String target_ssid, String message)
{
...
void ESP8266WiFiMesh2::attemptScan(String message)
{
	/* Scan for APs */
...
void ESP8266WiFiMesh2::acceptRequest()
{
	while (true) {
